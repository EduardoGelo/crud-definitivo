...
<body>
    <x-app-layout>
        ...
        <div class="chart-container">
            <h3>Distribuição dos Produtos</h3>
        ...
        <script>
            ...
            const myPieChart = new Chart(ctx, {
                type: 'pie', // tipo de gráfico como "pie" ou pizza, se quiser mudar pesquise um
                data: {
                    labels: ['Clientes', 'Produtos', 'Categorias', 'Materiais'],
                    datasets: [{
                        label: 'Quantidade',
                        data: [
                            {{ $counts['clientes'] }},
                        ...
                        backgroundColor: ['#ff5733', '#33c1ff', '#ffeb33', '#33ff57'], 
                        borderColor: ['#c0392b', '#0099cc', '#e0c100', '#1cbb38'], 
                        borderWidth: 1
                    }]
                },
                options: {
        ...
        <div class="w3-row-padding w3-padding-64 w3-container">
            <div class="w3-content">
                <div class="w3-twothird">
                    <h1>Introdução:</h1>
                    <h5 style="text-align: justify" class="w3-padding-32">&emsp;&emsp;&emsp;Adquira aqui os melhores produtos para você que curte artesanatos!</h5>
        ...
        <div class="w3-row-padding w3-light-grey w3-padding-64 w3-container">
            <div class="w3-content">
                ...
                <div class="w3-twothird">
                    ...
                    <h5 style="text-align: justify" class="w3-padding-32">&emsp;&emsp;&emsp;Faça seu pedido na página de agendamentos.</h5>
